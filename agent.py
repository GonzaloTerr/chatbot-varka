...
async def _responder(historial: list[dict], texto: str, push_name: str) -> str:
    ...
    if historial:
        ...
        # Art. 50.1 del Reglamento Europeo de IA: la persona tiene que saber de entrada
        # que habla con una IA. Va pegado al turno porque Haiku obedece mas aca que en el system.
        nota = ("[ESTADO: primer mensaje de esta persona. Saluda y presentate UNA sola vez, breve, "
                "como Sofia, la asistente virtual con IA de Varka.]")
